        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600">Edit data nasabah bank sampah</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-blue-50 to-green-50 px-8 py-6 border-b border-gray-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold text-gray-800">Form Edit Nasabah</h3>
                            <p class="text-sm text-gray-600">Perbarui data nasabah dengan benar</p>
                        </div>
                    </div>
                </div>

                <!-- Form Content -->
                <form action="{{ route('admin.nasabah.update', $nasabah->id) }}" method="POST" class="p-8" id="editNasabahForm">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea id="alamat"
                                              ...
                                              placeholder="Masukkan alamat lengkap (opsional)">{{ old('alamat', $nasabah->alamat) }}</textarea>
                                </div>
                                @error('alamat')
                                    <p class="text-sm text-red-600 flex items-center mt-1">
                                        <i class="fas fa-exclamation-circle mr-1"></i>
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="text-xs text-gray-500 mt-1">
                                    <p>Minimal 8 karakter (isi hanya jika ingin mengubah password)</p>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <label class="relative flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                        <input type="radio"
                                               ...
                                               value="active"
                                               class="sr-only peer"
                                               {{ old('status', $nasabah->status) == 'active' ? 'checked' : '' }}
                                               required>
                                    ...
                                    <label class="relative flex items-center p-4 border border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 transition-colors">
                                        <input type="radio"
                                               ...
                                               value="inactive"
                                               class="sr-only peer"
                                               {{ old('status', $nasabah->status) == 'inactive' ? 'checked' : '' }}>
        ...
        function resetForm() {
            if (confirm('Apakah Anda yakin ingin mengembalikan semua perubahan?')) {
                ...
                const originalValues = {
                    name: "{{ addslashes($nasabah->name) }}",
                    email: "{{ addslashes($nasabah->email) }}",
                    alamat: "{{ addslashes($nasabah->alamat) }}",
                    saldo: "{{ $nasabah->saldo }}",
                ...
                document.getElementById('saldo').value = originalValues.saldo;
