...
<body class="bg-gray-50 overflow-x-hidden">
    ...
    <aside id="sidebar"
        ...
        <div class="p-4 border-b border-white/10 flex items-center justify-center">
            <div class="flex items-center gap-3">
                ...
                <div class="sidebar-header-text">
                    ...
                    <p class="text-xs text-white/70">Nasabah Panel</p>
                </div>
            </div>
        </div>
        ...
        <nav class="flex-1 px-2 py-4 overflow-y-auto scrollbar-thin">
            <div class="space-y-1">
                ...
                <a href="{{ route('nasabah.tarik.tunai') }}"
                    class="nav-link-hover flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium text-white/90 hover:text-white group sidebar-icon-only">
                ...
                <a href="{{ route('nasabah.riwayat.index') }}"
                    class="nav-link-hover flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium text-white/90 hover:text-white group sidebar-icon-only">
                    <i class="fas fa-history text-lg w-6 text-center group-hover:scale-110 transition-transform"></i>
            ...
            <div class="flex items-center gap-3 p-2 rounded-lg glass-effect hover:bg-white/10 transition-colors">
                <a href="{{ route('nasabah.profile.edit') }}"
                    ...
                    <div class="flex-1 sidebar-text">
                        ...
                        <small class="text-xs text-white/70">Nasabah</small>
                    </div>
                </a>
            </div>
    ...
    <header id="topbar"
        ...
        <div class="flex items-center space-x-4">
            ...
            <h1 class="text-lg font-semibold text-gray-800">@yield('title', 'Dashboard Nasabah')</h1>
        </div>
        <!-- Right -->
        <div class="flex items-center space-x-4">
