...
<div class="min-h-screen bg-gray-50 py-12">
    <div class="p-4 md:p-8">
        <div class="max-w-4xl mx-auto">
            <!-- Page Header -->
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-800">Edit Profil Admin Bank Sampah</h1>
                <p class="text-gray-500 text-sm mt-1">Perbarui informasi admin untuk pengelolaan transaksi dan data nasabah</p>
            </div>
                ...
                <form method="POST" action="{{ route('profile.update') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <!-- Identitas Admin -->
                            <div class="mb-6">
                                <h2 class="text-lg font-semibold mb-4 text-gray-800 border-b pb-2">Identitas Admin</h2>
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500 mt-1">ID Admin: {{ auth()->user()->id }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium">Akun Admin Aktif</span>
                                    </div>
                                    <p class="text-sm text-gray-600 mt-2">Akun siap digunakan untuk mengelola sistem Bank Sampah</p>
                        ...
                        <!-- Right Column -->
                        <div>
                            <h2 class="text-lg font-semibold mb-4 text-gray-800 border-b pb-2">Informasi Akun Admin</h2>
            ...
            <div class="mt-6 bg-white rounded-lg shadow-md p-6">
                <h2 class="text-lg font-semibold mb-4 text-gray-800 border-b pb-2">Panduan Admin Bank Sampah</h2>
                <div class="space-y-3">
                    @foreach([
                        'Selalu perbarui informasi admin untuk keamanan sistem.',
                        'Gunakan password yang kuat dan ganti secara berkala.',
                        'Kelola nasabah dan transaksi dengan teliti untuk menghindari kesalahan data.',
                        'Periksa log aktivitas secara rutin untuk keamanan Bank Sampah.'
                    ] as $tip)
