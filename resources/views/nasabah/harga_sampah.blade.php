    ...
    <div class="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 mt-10">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Temukan harga terbaru untuk berbagai jenis sampah
                    yang dapat didaur ulang</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @foreach ($sampah as $item)
                    <div
                        class="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-green-100 p-6 text-center">
                        ...
                        <!-- Harga -->
                        <div
                            class="p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-100 inline-block">
            ...
            <div class="mt-16 bg-white rounded-2xl shadow-lg border border-green-100 p-8">
                <div class="grid md:grid-cols-3 gap-6 text-center">
                    <div class="flex flex-col items-center">
                        ...
                        <p class="text-sm text-gray-600">Harga yang kompetitif dan transparan untuk semua jenis sampah
                        </p>
                    </div>
